...
namespace Pulumi.Statuspage
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Statuspage.version.txt");
    ...
    internal sealed class StatuspageResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public StatuspageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
