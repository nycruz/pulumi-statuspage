...
class ComponentGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] components: An array with the IDs of the components in this group
        :param pulumi.Input[str] page_id: the ID of the page this component group belongs to
        :param pulumi.Input[str] description: More detailed description for this component group
        :param pulumi.Input[str] name: An array with the IDs of the components in this group
        """
