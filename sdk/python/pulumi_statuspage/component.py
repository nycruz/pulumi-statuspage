...
class ComponentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: More detailed description for the component
        :param pulumi.Input[str] name: Display Name for the component
        :param pulumi.Input[bool] showcase: Should this component be shown component only if in degraded state
        :param pulumi.Input[str] start_date: Should this component be showcased
        """
